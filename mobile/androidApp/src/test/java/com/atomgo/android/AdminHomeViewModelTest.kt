    ...
    fun fetchAdminRents_returnsRepositoryValue() = runTest {
        ...
        val vm = AdminHomeViewModel(
            adminRepository = object : AdminRepository {
                ...
                override suspend fun updateBike(accessToken: String, bikeId: String, bikeModel: String, weeklyRateRub: Int, frameSerialNumber: String, motorSerialNumber: String, batterySerialNumber1: String, batterySerialNumber2: String?) = Unit
