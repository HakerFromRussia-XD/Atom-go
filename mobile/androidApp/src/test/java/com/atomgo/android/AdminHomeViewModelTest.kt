...
private open class FakeAdminRepository(
    ...
    override suspend fun createRental(accessToken: String, clientId: String?, bikeId: String, login: String, password: String, periodStart: String, periodEnd: String?, paymentDay: Int, videoUrl: String?, contractUrl: String?, comment: String?) = Unit
    ...
    override suspend fun deleteBike(accessToken: String, bikeId: String) = Unit
    ...
    override suspend fun updateRental(accessToken: String, rentalId: String, bikeId: String, periodStart: String, periodEnd: String?, paymentDay: Int, login: String?, password: String?, videoUrl: String?, contractUrl: String?, comment: String?) = Unit
    ...
    override suspend fun startClientRentalInExisting(accessToken: String, rentalId: String, clientId: String, login: String, password: String, periodStart: String, paymentDay: Int) = Unit
