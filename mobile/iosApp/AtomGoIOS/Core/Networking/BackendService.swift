...
private enum BackendErrorMessageParser {
    private static let knownMessageMap: [String: String] = [
        ...
        "client is used by rentals": "Клиент уже скрывается soft-delete. Обновите данные и попробуйте ещё раз.",
        "bike is used by rentals": "Велосипед уже скрывается soft-delete. Обновите данные и попробуйте ещё раз.",
